...
from autotrans import whisper_model,utils
from autotrans.type import WhisperMode , SPEECH_ARRAY_INDEX
...
class Transcribe:
    ...
    def run(self):
        ...
        for input in self.args.inputs:
            ...
            logging.info(f"Save text to {name + '.md' } to mark sentences")
    ...
    def _save_md(self, md_fn, srt_fn, video_fn):
        ...
        md.add(
            ...
            "Mark the sentences to keep for autotrans.\n"
